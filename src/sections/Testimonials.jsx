        ...
        <div id="clients" className="w-full ">
            ...
            items-center gap-[20px]">
               ...
               WHAT OUR CLIENTS SAYS
                ...
                className="w-[500px] h-[6px] bg-yellow-500">

                </motion.div>
                {/* make div for services mapping from export vs file */}
                <motion.div
                initial="hidden"
                whileInView="visible"
                variants={zoomInVariants}
                className="lg:w-full w-[90%] grid lg:grid-cols-3 grid-cols-1
                 justify-center items-start gap-8 mt-[30px]">
                   
                {
                    clients.map((item,index)=>(
                        <div key={index} className="flex flex-col justify-center items-center">
                            ...
                            <div className="flex flex-col justify-center items-center gep-[5px]">
